...
const zh: Dict = {
  ...
  removedText: "已删除",
  unchangedText: "保留原文",
  noChangesDetected: "未检测到修改",
  rewriteFailed: "改写失败",
  rewriteFailedDescription: "模型暂时没有返回可用结果。原文没有被改动，请重试。",
  retry: "重试",
...
const en: Dict = {
  ...
  changedText: "Added or changed",
  removedText: "Removed",
  unchangedText: "Unchanged",
  noChangesDetected: "No changes detected",
  rewriteFailed: "Rewrite failed",
  rewriteFailedDescription: "The model did not return a usable result. Your original text is unchanged. Please try again.",
  retry: "Try again",
